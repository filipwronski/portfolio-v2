    ...
    <div class="portfolio-wrapper">
        <div class="portfolio portfolio--list" :class="{visible : isHeightChanged}">
            <vue-scrollbar classes="portfolio__scrollbar" ref="Scrollbar">
                <div class="scroll-me">
                    <div class="grid">
                        <div class="col-4_md-6_sm-12" v-for="(project, index) in projects" :key="project.path">
                            <router-link class="project-list" ref="projectList" :style="projectListStyle"
                                         :to="{ name: 'portfolio.home', params: { name: project.path }}">
                                <img class="project__image" :src="loadImage(project.img)">
                                <h3 class="project-list__title">{{ project.title }}</h3>
                                <p class="project-list__description">{{ project.excerpt }}</p>
                            </router-link>
                        </div>
                    </div>
                </div>
        ...
        <div class="portfolio portfolio--mobile">
            <div class="grid">
                <div class="col-3_md-4_sm-12-middle" v-for="(project, index) in projects" :key="project.path">
                    <router-link class="project-list"
                                 :to="{ name: 'portfolio.home', params: { name: project.path }}">
                        <h3 class="project-list__title">{{ project.title }}</h3>
                        <p class="project-list__description">{{ project.excerpt }}</p>
                    </router-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getHighestEl: function (elements) {
                let highestEl = 0;
            ...
            setEqualHeight: function (elements) {
                let highestEl = this.getHighestEl(elements);
